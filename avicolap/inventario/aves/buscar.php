    ...
    <div id="tabla">
        ...
        <tr>
            ...
            <?php
             ...
             $sql="SELECT * FROM aves WHERE id_gallina LIKE '%$buscar%' or codigo  LIKE '%$buscar%' or raza LIKE '%$buscar%' OR estatus LIKE '%$buscar%' OR fechanac LIKE '%$buscar%' ORDER by fechanac  DESC; ";
